...
void main(){
 // Laptop ob1 = Laptop('Macbook', 100000.0);
  Macbook macObj = Macbook('Apple Macbook', 1450.0, 'M3');
  macObj.display();
}
...
String model;
  // When the super class contains a constructor then we need to initialize that constructor in the derived class/child class with the superr keyword
...
Macbook(String brand, double price, this.model) : super(brand, price); // when i will assign the value through object the value will be initialized in the parent class variable
