...
class MacBook implements Laptop{
  ...
  //The advantage of implementing is that with overriden method the user can define and use in their own specific way
...
//NOTE- here we are using the concept of abstraction, multilevel inheritance and method overriding(Meaning run time polymorphism)
  @override
